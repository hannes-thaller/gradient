...
from .. import util, entity
from . import transformation, optimization
...
class NvpKernel:
    ...
    feature_description_x: "entity.FeatureDescription" = attr.ib(init=False)
    feature_description_z: "entity.FeatureDescription" = attr.ib(init=False)
    ...
    def fit(self, arrs: typing.List[np.ndarray], feature_description: "entity.FeatureDescription",
            hyper_parameters: "entity.HyperParameters") -> "entity.TrainingProgress":
