...
from gradient_inference.model import transformation
from . import arb
...
def test_scale_transformation_fit_float32(feature, arr_fit, arr_transform):
    ...
    assert feature
    assert feature.data_type.descriptor == entity.DataTypeDescriptor.FLOAT
...
def test_ordinal_transformation_fit_int32(feature, arr_fit, arr_transform):
    ...
    assert feature
    assert feature.data_type.descriptor == entity.DataTypeDescriptor.INTEGER
