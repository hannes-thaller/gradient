...
class ProgramRepository:
    ...
    _index_type: "typing.Dict[int, code.CodeElement]" = attr.ib(init=False)
    _index_property: "typing.Dict[int, code.CodeElement]" = attr.ib(init=False)
    _index_executable: "typing.Dict[int, code.CodeElement]" = attr.ib(init=False)
    _index_parameter: "typing.Dict[int, code.CodeElement]" = attr.ib(init=False)
    ...
    def create_type_index(
            program: "code.ProgramDetail"
    ) -> typing.Dict[int, code.CodeElement]:
        assert program
        return {it.id: it
