...
if typing.TYPE_CHECKING:
    ...
    ProgramRepositoryFactory = typing.Callable[["code_entity_pb2.ProgramDetail"], "persistence.ProgramRepository"]
...
class ModelService:
    ...
    def build_structure_graph(self, program: "code_entity_pb2.ProgramDetail"):
        assert program
...
class InferenceService:
    ...
    def create_program_graph(self, program: "code_entity_pb2.ProgramDetail"):
        assert program
